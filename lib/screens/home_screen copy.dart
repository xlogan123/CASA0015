...
class _HomeScreenState extends State<HomeScreen> {
  ...
  String temperature = "--";
  String weatherDetail = "Waiting for data...";
      ...
      if (_sessionStartTime != null) {
        ...
        try {
          await FirebaseFirestore.instance
              ...
              .add(walkData);
          debugPrint("✅ Walk data uploaded successfully!");

          // Show a snackbar to the user
          if (mounted) {
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(
                content: Text("🎉 Walk session ended! Data synced to cloud diary."),
          ...
          debugPrint("❌ Walk data upload failed: $e");
        }
      }
        ...
        child: Column(
          ...
          children: [
            ...
            AnimatedOpacity(
              ...
              child: Text(
                currentPace == "Fast"
                    ? "🔥 walking pace is fast, switched to rhythm music"
                    : "🍃 Walking slowly, playing soothing ambient sound",
            ...
            ElevatedButton(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    _isPlaying ? "End Session" : "Put on headphones to explore",
                    style: const TextStyle(
                      fontSize: 18,
                      color: Colors.white,
                      fontWeight: FontWeight.bold,
